...
fn add_swagger_ui<T: OpenApi + 'static, W: Webhook + 'static>(mut api_service: OpenApiService<T, W>, mut app: Route) -> (OpenApiService<T, W>, Route) {
...
fn add_swagger_ui<T: OpenApi + 'static, W: Webhook + 'static>(api_service: OpenApiService<T, W>, app: Route) -> (OpenApiService<T, W>, Route) {
  (api_service, app)
}
